...
class JudgingJob(Base):
    ...
    processed_submission_ids: Mapped[str] = mapped_column(Text, default="[]")
    created_at: Mapped[datetime] = mapped_column(DateTime, default=utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=utcnow, onupdate=utcnow)
...
class Submission(Base):
    ...
    system_score_adjustment: Mapped[float] = mapped_column(Float, default=0.0)
...
class Score(Base):
    ...
    positive_comment_1: Mapped[str] = mapped_column(Text)
    positive_comment_2: Mapped[str] = mapped_column(Text)
    positive_comment_3: Mapped[str] = mapped_column(Text)
    improvement_comment: Mapped[str] = mapped_column(Text)
